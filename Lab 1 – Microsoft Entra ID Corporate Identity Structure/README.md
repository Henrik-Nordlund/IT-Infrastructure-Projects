...
Administrative Units in Entra are used to organize users into defined administrative scopes based on some characteristics they have in common, making it possible to manage users within a specific organizational area rather than individually.
